...
public partial class Admin_Edit_Doctors : System.Web.UI.Page
{
    ...
    private void rep_bind()
    {
        ...
        selaryText.Text = reader["ID"].ToString();
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
       ...
       // Label1.Text = "The search Term " + TextBox1.Text + " &nbsp;Update";
        ...
        Label1.Visible = true;
        Label1.Text = "The search Term " + selaryText.Text + " &nbsp;Is Not Available in the Records";

        string update = "Update [DoctorsData] set Name=@name,Email=@email where ID ='" + selaryText.Text + "'";
